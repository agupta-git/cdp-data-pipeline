...
fs = "s3a://pse-uat2/angupta-demo" # UPDATE THIS VARIABLE TO POINT TO YOUR BUCKET
...
print("Load CDPH.COVID_RATE_BY_SOC_DET...")
...
print("Load MEMBER.TARGET_MBRS_BY_AGE_GROUP...")
...
print("Load MEMBER.TARGET_MBRS_BY_INCOME...")
